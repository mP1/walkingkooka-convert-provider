...
public final class ConvertersConverterProviderTest implements ConverterProviderTesting<ConvertersConverterProvider> {
    ...
    @Test
    public void testConverterCurrencyCodeToCurrency() {
        this.converterAndCheck(
            ConverterSelector.parse("currency-code-to-currency"),
            CONTEXT,
    ...
    @Test
    public void testConverterCurrencyValueToNumber() {
        this.converterAndCheck(
    ...
    @Test
    public void testConverterTextToCurrency() {
        this.converterAndCheck(
            ConverterSelector.parse("text-to-currency"),
            CONTEXT,
    ...
    @Test
    public void testConverterTextToCurrencyCode() {
        this.converterAndCheck(
    ...
    @Test
    public void testConverterTextToLocaleLanguageTagSet() {
        this.converterAndCheck(
            ConverterSelector.parse("text-to-locale-language-tag-set"),
            CONTEXT,
