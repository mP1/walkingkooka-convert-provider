...
final public class ConverterName implements PluginNameLike<ConverterName> {
    ...
    /**
     * The name of the {@link Converter} returned by {@link Converters#currencyCodeToCurrency()}
     */
    public final static ConverterName CURRENCY_CODE_TO_CURRENCY = registerConstantName(
        CURRENCY_CODE_TO_CURRENCY_STRING,
        Converters::currencyCodeToCurrency
    );

    private final static String CURRENCY_VALUE_TO_STRING = "currency-value-to";

    /**
     * The name of the {@link Converter} returned by {@link Converters#currencyValueTo()}
     */
    public final static ConverterName CURRENCY_VALUE_TO = registerConstantName(
    ...
    private final static String TEXT_TO_CURRENCY_CODE_SET_STRING = "text-to-currency-code-set";

    /**
     * The name of the {@link Converter} returned by {@link Converters#textToCurrencyCodeSet()}
     */
    public final static ConverterName TEXT_TO_CURRENCY_CODE_SET = registerConstantName(
        TEXT_TO_CURRENCY_CODE_SET_STRING,
    ...
    /**
     * The name of the {@link Converter} returned by {@link Converters#textToCurrencyValue()}
     */
    public final static ConverterName TEXT_TO_CURRENCY_VALUE = registerConstantName(
    ...
    /**
     * The name of the {@link Converter} returned by {@link Converters#textToLocaleLanguageTag()}
     */
    public final static ConverterName TEXT_TO_LOCALE_LANGUAGE_TAG = registerConstantName(
        TEXT_TO_LOCALE_LANGUAGE_TAG_STRING,
